...
//     const wrapper = mount(<Tree dataType="plain" props={props} data={data} />);
...
//     };
//     const wrapper2 = mount(<Tree dataType="plain" props={props2} data={data} />);
...
//     wrapper.find('.content').at(0).simulate('click', { currentTarget: { classList: [] } });
...
//       },
//     ]
//     const wrapper = mount(<Tree data={data} autoExpandOnSelect={false} />);
//     wrapper
//       .find('span')
//       .at(0)
//       .simulate('click');
...
//         if (root.id === 1 && !root.children.lenghth) {
...
//       });
//     }
//     holdWrapper = mount(<Tree data={holdData} loadMore={holdLoadMore} />);
...
//       });
//     }
//     wrapper = mount(<Tree data={data} loadMore={holdLoadMore} />);
...
//       expect(
//         wrapper
//           .find('.tree-node-loading-wrapper')
//           .length
//       ).toBe(0);
...
//     expect(wrapper.find('Checkbox').not({ disabled: true }).everyWhere(n => n.prop('checked'))).toBe(
//       true
//     );
//     expect(
//       wrapper
...
//       }
//     ];
//     const disabledWrapper = mount(<Tree data={disabledData} checkable disabledCheckedKeys={[2, 3]} />);
...
//       },
//     ];
//     const iconWrapper = mount(<Tree data={data} operations={iconOperations} />);
