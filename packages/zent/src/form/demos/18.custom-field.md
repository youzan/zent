...
function FormIDField({
	...
	const onChange = React.useCallback(
		e => {
      console.log('eee', e, anchorRef.current, model, model.valid());
			id.isTouched = true;
...
function App() {
	// const form1 = Form.useForm(FormStrategy.View);
  // console.log('form1', form1);
	const form = Form.useForm(formBuilder);
	
	return (
		<Form form={form} scrollToError={true} layout="horizontal" onSubmit={() => console.log('submit')}>
			<FormIDField
