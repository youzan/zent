...
zh-CN:
	...
	name: 用户名
	nickName: 昵称
	namedescription: 正则校验(onBlur时触发)
	nickNamedescription: 正则校验(onChange时触发)
...
en-US:
	...
	name: Name
	nickName: NickName
	namedescription: regular validation(onBlur)
	nickNamedescription: regular validation(onChange)
	...
	return (
		<Form form={form} layout="horizontal" scrollToError>
			...
			<FormInputField
				...
				label="{i18n.nickName}:"
				required
				helpDesc="{i18n.nickNamedescription}"
