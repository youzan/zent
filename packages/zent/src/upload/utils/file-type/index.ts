...
const getFileType = input => {
  ...
  if (
    check([0x75, 0x73, 0x74, 0x61, 0x72], {
      offset: 257,
    })
  ) {
    return {
  ...
  if (
    check([0x0, 0x0, 0x0, 0x1c, 0x66, 0x74, 0x79, 0x70, 0x33, 0x67, 0x70, 0x34])
  ) {
    return {
      ext: '3gp',
      mime: 'video/3gpp',
  ...
  if (
    check([0x66, 0x74, 0x79, 0x70, 0x4d, 0x34, 0x41], {
      offset: 4,
    }) ||
  ...
  if (
    check([0x4f, 0x70, 0x75, 0x73, 0x48, 0x65, 0x61, 0x64], {
      offset: 28,
    })
  ) {
    return {
  ...
  if (check([0x4f, 0x67, 0x67, 0x53])) {
    ...
    // If ' theora' in header.
    if (
      check([0x80, 0x74, 0x68, 0x65, 0x6f, 0x72, 0x61], {
        offset: 28,
      })
    ) {
      return {
