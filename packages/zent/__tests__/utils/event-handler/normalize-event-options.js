...
jest.mock('utils/component/event-handler/supports-passive');

import { canUsePassiveEventListeners } from 'utils/component/event-handler/supports-passive';
import { normalizeEventOptions } from 'utils/component/event-handler/normalize-event-options';
