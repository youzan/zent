...
- `Icon`
  - ✨ 更新 zenticons 版本至 3.7.6

### 9.12.15(2024-06-12)

- `Icon`
  - ✨ 更新 zenticons 版本至 3.7.5

### 9.12.14(2024-05-20)

- 🦀️ 修复因 `observable-hooks` 自动升级 `4.3.2` 下的打包报错问题

- `Dialog`
  - ✨ 增加 `position` 属性支持
- `Notify`
  - ✨ 增加 `containerSelector` 和 `className `属性支持

### 9.12.13(2023-01-06)

- 🦀️ 调整 `CombinedDateRangePicker` 在选择完日期之后结束日期的展示逻辑

### 9.12.12(2022-12-27)

- 🦀️ 修复 `ErrorBoundary` `onError` 的类型定义

### 9.12.11(2022-12-27)

- 🦀️ 修复 `NumberInput` 在一些情况下渲染死循环的问题(9.12.10 导致的新问题)

### 9.12.10(2022-12-24)

- 🦀️ 修复 `NumberInput` 在一些情况下渲染死循环的问题

### 9.12.9(2022-11-21)

- 调整 `Alert` 和 `Input` 组件图标按钮的图标大小为 `20px`

### 9.12.8-rc.0(2022-05-31)

- `Cascader`
  - ✨ 当配置了 `searchable` 时，也支持了 placeholder
