...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var PageComponent = __webpack_require__(168)("./" + window.Component + '.js');
	
	_reactDom2['default'].render(_react2['default'].createElement(PageComponent, null), document.getElementById('react-component-container'));
	...
	*/
	...
	var Advanced = (function (_Component) {
	    ...
	    function Advanced(props) {
	        ...
	        _get(Object.getPrototypeOf(Advanced.prototype), 'constructor', this).call(this, props);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(187);
	var warning = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcSelect = __webpack_require__(201);
	
	var _srcSelect2 = _interopRequireDefault(_srcSelect);
	
	var _srcIndex = __webpack_require__(204);
	
	var _srcIndex2 = _interopRequireDefault(_srcIndex);
	
	__webpack_require__(202);
	
	var Option = _srcSelect2['default'].Option;
	
	var data = ['Hard 模式', 'Very Hard 模式', '死亡'];
	...
	var Example = (function (_Component) {
	  ...
	  _createClass(Example, [{
	    ...
	    value: function handleChange(data) {
	      alert(data ? '你选择了 ' + data.text : '请选择一种模式');
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'form',
	        null,
	        _react2['default'].createElement(_srcIndex2['default'], { data: data, onChange: this.handleChange.bind(this) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Select = (function (_Component) {
	  ...
	  _createClass(Select, [{
	    ...
	    value: function getChildContext() {
	      return {
	        handleOptionClicked: this.handleOptionClicked.bind(this)
	      };
	    }
	  }, {
	    key: 'handleOptionClicked',
	    value: function handleOptionClicked(data) {
	    ...
	    key: 'handleSelectClicked',
	    value: function handleSelectClicked() {
	      this.props.onClick();
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'span',
	          { className: className + '-selected', onClick: this.handleSelectClicked.bind(this) },
	          text
	        ),
	        _react2['default'].createElement(
	          'span',
	          { className: className + '-popup' + (active ? '' : ' hide') },
	          this.props.children
	        )
	      );
	    }
	...
	Select.defaultProps = {
	  ...
	  onClick: function onClick() {
	    console.log('click Zent Select!');
	  }
	};
	
	Select.childContextTypes = {
	  handleOptionClicked: _react2['default'].PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".zent-select {\n\n}\n\n.zent-select-selected {\n    border: 1px solid #ccc;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Select = (function (_Component) {
	  ...
	  function Select(props) {
	    ...
	    _get(Object.getPrototypeOf(Select.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      data: props.data.map(function (item, index) {
	  ...
	  _createClass(Select, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['placeholder', 'onChange', 'data']);
	
	      data = this.state.data;
	
	      return _react2['default'].createElement(
	        'select',
	        _extends({}, props, { onChange: this.handleChange.bind(this) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Option = (function (_Component) {
	  ...
	  _createClass(Option, [{
	    key: 'handleOptionClicked',
	    value: function handleOptionClicked() {
	      this.context.handleOptionClicked(this.state);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'span',
	        { onClick: this.handleOptionClicked.bind(this) },
	        this.state.text
	      );
	    }
	  }]);
