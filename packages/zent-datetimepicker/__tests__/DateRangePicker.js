...
describe('DateRangePicker', () => {
  it('DateRangePicker has its core function', () => {
    ...
    wrapper.find('.picker-input').simulate('click');
    pop.find('DatePanel').at(0).find('.panel__cell')
      .at(10)
      .simulate('click');
    pop.find('DatePanel').at(0).find('.panel__cell')
      .at(10)
      .simulate('mouseover');
    pop.find('DatePanel').at(1).find('.panel__cell')
      .at(20)
      .simulate('mouseover');
    pop.find('DatePanel').at(1).find('.panel__cell')
      .at(20)
    ...
    pop.find('DatePanel').at(0).find('.panel__cell')
      .at(20)
      .simulate('click');
    pop.find('TimePanel').at(0).find('.time__number')
      .at(0)
      .simulate('click');
    pop.find('HourPanel .panel__cell').at(5).simulate('click');
    pop.find('TimePanel').at(1).find('.time__number')
      .at(0)
      .simulate('click');
