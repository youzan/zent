...
describe('Controlled CheckboxGroup', () => {
  ...
  it('onChange', () => {
    ...
    const bananaCheckboxInputNode = TestUtils.findRenderedDOMComponentWithTag(bananaCheckbox, 'input')
    const appleCheckboxInputNode = TestUtils.findRenderedDOMComponentWithTag(appleCheckbox, 'input')

    TestUtils.Simulate.change(bananaCheckboxInputNode, { target: { checked: true } })
    expect(value).toEqual(['apple', 'banana'])

    TestUtils.Simulate.change(appleCheckboxInputNode, { target: { checked: true } })
  ...
  describe('disabled', () => {
    it('disabled group', () => {
      ...
      const appleCheckboxInputNode = TestUtils.findRenderedDOMComponentWithTag(checkboxs[0], 'input')
      const bananaCheckboxInputNode = TestUtils.findRenderedDOMComponentWithTag(checkboxs[1], 'input')
    ...
    it('checkbox disabled in group', () => {
      ...
      expect(appleCheckboxNode.className).toContain('zent-checkbox-disabled')
      expect(bananaCheckboxNode.className).not.toContain('zent-checkbox-disabled')
    ...
    it('checkbox not disabled in disabled group', () => {
      ...
      expect(appleCheckboxNode.className).not.toContain('zent-checkbox-disabled')
      expect(bananaCheckboxNode.className).toContain('zent-checkbox-disabled')
